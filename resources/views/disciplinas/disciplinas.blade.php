...
@section('content')
  <div class="mb-8 flex flex-col items-center justify-center gap-2">
    <div class="flex items-center justify-around gap-8">
      ...
      <form method="GET" action="{{ url('/disciplinas') }}" class="flex items-center gap-x-2 p-0 m-0">
        <input type="text" name="nome" placeholder="Procurar disciplina" value="{{ request('nome') }}" class="input">
