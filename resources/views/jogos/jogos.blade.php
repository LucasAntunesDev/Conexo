...
<section class="flex gap-x-2 items-center mx-auto my-4">
...
<main class="flex flex-col gap-2 w-screen justify-center items-center grow">
    ...
    <div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full appear">
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-violet-50 rounded-2xl shadow">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t-2xl">
                    ...
                    <button type="button" class="text-violet-400 bg-transparent hover:text-violet-700 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center " data-modal-toggle="crud-modal">
    ...
    <div class="grid grid-cols-4 grid-rows-4 gap-2 p-4 justify-items-center">
        ...
        <div id="edit-modal{{$jogo->id}}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full appear">
            <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="bg-violet-50 w-fit p-6 rounded-xl h-auto lista-item">
            ...
            <a href="{{ route('jogo', ['id' => $jogo->id]) }}" class="flex text-violet-900  font-semibold w-56 text-lg lista-titulo">
                {{ $jogo->nome}}
            </a>
